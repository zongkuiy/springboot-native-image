...
import com.nativeapp.demo.dao.SysParamsExample.Criteria;
import com.nativeapp.demo.dao.SysParamsExample.Criterion;
import com.nativeapp.demo.dao.SysParamsExample;
import java.util.List;
import java.util.Map;

public class SysParamsSqlProvider {

    public String countByExample(SysParamsExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("sys_params");
    ...
    public String deleteByExample(SysParamsExample example) {
        BEGIN();
        DELETE_FROM("sys_params");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(SysParams record) {
        BEGIN();
        INSERT_INTO("sys_params");
        ...
        if (record.getParamType() != null) {
            VALUES("param_type", "#{paramType,jdbcType=TINYINT}");
        }
    ...
    public String selectByExample(SysParamsExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SysParams record = (SysParams) parameter.get("record");
        SysParamsExample example = (SysParamsExample) parameter.get("example");
        ...
        if (record.getParamType() != null) {
            SET("param_type = #{record.paramType,jdbcType=TINYINT}");
        }
    ...
    public String updateByPrimaryKeySelective(SysParams record) {
        BEGIN();
        UPDATE("sys_params");
        ...
        if (record.getParamType() != null) {
            SET("param_type = #{paramType,jdbcType=TINYINT}");
        }
    ...
    protected void applyWhere(SysParamsExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
