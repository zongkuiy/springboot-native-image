...
import com.nativeapp.demo.dao.SysOrgExample.Criteria;
import com.nativeapp.demo.dao.SysOrgExample.Criterion;
...
public class SysOrgSqlProvider {
    ...
    public String insertSelective(SysOrg record) {
        ...
        if (record.getPid() != null) {
            VALUES("pid", "#{pid,jdbcType=BIGINT}");
        }
        ...
        if (record.getLeaderId() != null) {
            VALUES("leader_id", "#{leaderId,jdbcType=BIGINT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getLeaderId() != null) {
            SET("leader_id = #{record.leaderId,jdbcType=BIGINT}");
        }
