...
import com.nativeapp.demo.dao.SmsLogExample.Criteria;
import com.nativeapp.demo.dao.SmsLogExample.Criterion;
...
public class SmsLogSqlProvider {
    ...
    public String countByExample(SmsLogExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("sms_log");
    ...
    public String deleteByExample(SmsLogExample example) {
        BEGIN();
        DELETE_FROM("sms_log");
        applyWhere(example, false);
        return SQL();
    ...
    public String insertSelective(SmsLog record) {
        BEGIN();
        INSERT_INTO("sms_log");
        
        if (record.getPlatformId() != null) {
            VALUES("platform_id", "#{platformId,jdbcType=BIGINT}");
        }
    ...
    public String selectByExample(SmsLogExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SmsLog record = (SmsLog) parameter.get("record");
        SmsLogExample example = (SmsLogExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(SmsLog record) {
        BEGIN();
        UPDATE("sms_log");
    ...
    protected void applyWhere(SmsLogExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
