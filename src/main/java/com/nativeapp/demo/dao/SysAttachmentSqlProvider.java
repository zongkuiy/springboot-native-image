...
import com.nativeapp.demo.dao.SysAttachmentExample.Criteria;
import com.nativeapp.demo.dao.SysAttachmentExample.Criterion;
...
public class SysAttachmentSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getSize() != null) {
            SET("size = #{record.size,jdbcType=BIGINT}");
        }
    ...
    protected void applyWhere(SysAttachmentExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
