...
import com.nativeapp.demo.dao.SysPostExample.Criteria;
import com.nativeapp.demo.dao.SysPostExample.Criterion;
...
public class SysPostSqlProvider {
    ...
    public String countByExample(SysPostExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("sys_post");
    ...
    public String deleteByExample(SysPostExample example) {
        BEGIN();
        DELETE_FROM("sys_post");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(SysPost record) {
        BEGIN();
        INSERT_INTO("sys_post");
    ...
    public String selectByExample(SysPostExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SysPost record = (SysPost) parameter.get("record");
        SysPostExample example = (SysPostExample) parameter.get("example");
        ...
        if (record.getPostName() != null) {
            SET("post_name = #{record.postName,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(SysPost record) {
        BEGIN();
        UPDATE("sys_post");
    ...
    protected void applyWhere(SysPostExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
